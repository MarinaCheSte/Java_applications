...
public class InsertTestData {
    ...
    private static void updateAuthorsTable(Statement stmt) {
        ...
        try {
            ...
            System.out.println("Execute Update Failed 1!");
            e.printStackTrace();
            return;
        }
        for (int i = 1; i <= authorFirstNames.length; i++) {
            updateAuthorsTable = "INSERT INTO authors (firstName, lastName)"
                    + "VALUES ('" + authorFirstNames[i - 1]
                    + "', '" + authorLastNames[i - 1] + "');";
            try {
                stmt.executeUpdate(updateAuthorsTable);
            } catch (SQLException e) {
                System.out.println("Execute Update Failed 2!");
                e.printStackTrace();
                return;
            }
        }
    ...
    private static void updateAuthorIsbnTable(Statement stmt) {
        ...
        for (int i = 1; i <= isbn.length; i++) {
            ...
            try {
                ...
                System.out.println("Execute Update Failed 3!");
                e.printStackTrace();
                return;
            }
        }
    ...
    private static void updateTitlesTable(Statement stmt) {
        ...
        for (int i = 0; i < isbn.length; i++) {
            ...
            try {
                ...
                System.out.println("Execute Update Failed 4!");
                e.printStackTrace();
                return;
            }
        }
    ...
    private static void updatePublishersTable(Statement stmt) {
        ...
        try {
            ...
            System.out.println("Execute Update Failed 5!");
            e.printStackTrace();
            return;
        }
        for (int i = 0; i < publishers.length; i++) {
            ...
            try {
                ...
                System.out.println("Execute Update Failed 6!");
                e.printStackTrace();
                return;
            }
        }
