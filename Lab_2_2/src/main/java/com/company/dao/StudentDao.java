...
//import java.mysql.jdbc.exceptions.MySQLIntegrityConstraintViolationException;
...
public class StudentDao {
    ...
    public int insert(Student student) {
        ...
        try {
            String query = "insert into student(fname,lname,address,mobile_no," +
                    "email_id,city,designation,dob,doj,salary) "
                    + "values(?,?,?,?,?,?,?,?,?,?)";
    ...
    public List<Student> searchByName(String name, String surname) {
        ...
        try {
            ...
            String query = "select * from student where fname=? && lname like ? ";
            ps = con.prepareStatement(query);
            ps.setString(1, name);
